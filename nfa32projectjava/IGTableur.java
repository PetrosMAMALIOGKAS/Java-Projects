...
public class IGTableur extends JFrame {
	...
	/** 
	 * Constructeur prennant en parametre un objet a  qui correspond 
	 * à votre application métier (qui contient une répresentation de l'état courant
	 * du tableur et les méthodes pour le modifier).
	 * 
	 * @param a application metier avec representation courante du tableur.
	 */
	...
	/** 
	 * Action pour sélection d'une case:
	 * - appel a getContenu sur les coordonnees de la case
	 * - idealement, getContenu retourne contenu "source" de la case
	 *   pour permettre son edition
	 * @param x  ligne case
	 * @param y  colonne case
	 */
	...
	/** 
	 * Action  de click ok pour modification de cellule.
	 *  Affiche éventuellement message d'erreur accompagnant exception.
	 *  Idealement, doit modifier la structure du tableur, puis
	 *  rafraichir toutes les cases de l'interface graphique.
	 */
	void clickOK(){
		try{
	 ...
	 * @param c colonne (char)
	 * @param l ligne   (int)
	 * @param v chaine qui sera affichee
	 */
